...
import com.decadance.board.service.BoardDeleteService;
import com.decadance.board.service.BoardListService;
import com.decadance.board.service.BoardModifyService;
...
public class BoardController extends HttpServlet {
	...
	private void doRequest(HttpServletRequest request, HttpServletResponse response )throws ServletException, IOException {
		...
		} else if(com.equals("/board/modify_view.board")) {
			service = new BoardContentService();
			service.executeService(request, response);
			view = "/board/modify_view.jsp";
