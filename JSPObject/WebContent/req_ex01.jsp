...
/* 	String을 기본 데이터 타입으로 치환하는 방법
	String str1 = "10";
	String str2 = "20";
	str1 * str2 가 안 됨 -> int로 바꿔 줘야 함
	Integer라는 wrapper class를 사용함 : Integer.parseInt(str1); Integer.parseInt(str2);
	parseInt()는 static(정적) 메소드이기 때문에 바로 Integer class 접근 가능한 것! 
