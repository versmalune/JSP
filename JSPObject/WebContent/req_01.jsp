<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	// HttpServlet request = new 이런 거 안 만들어도 됨!
	...
	String conPath = request.getContextPath(); //context root 가지고 옴 ex)위 주소에서 '/pancakes' 정보
...
<body>
	...
	요청 URL 정보: <%= reqUrl %> <br>
	요청 URI 정보: <%= reqUri %> <br>
	요청 파라미터 변수: <%= query %> <br> <!-- url뒤에 '?변수이름 = 정보' 쓰고 엔터 누르고 전송 -->
